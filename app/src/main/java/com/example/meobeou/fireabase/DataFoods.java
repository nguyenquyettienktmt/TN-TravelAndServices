...
public class DataFoods {
    ...
    public static ArrayList<Data> getDataRecyViewFood(String key, final RecyclerView ry, final Context context) {

        dataFoods = FirebaseDatabase.getInstance().getReference().child("AmThuc").child(key);
        dataFoods.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                dataAdapter =new DataAdapterFoods(listFoods,context,1);
